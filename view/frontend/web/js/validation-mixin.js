define(['jquery'], function($) {
    ...
    return function() {
        ...
        $.validator.addMethod(
            'validate-cpf-cnpj',
            function(value, element) {
                return brValidator.validCpf(value) || brValidator.validCpf(value);
            },
            $.mage.__('Please enter a valid CPF ou CNPJ')
        );
        ...
        $.validator.addMethod(
            ...
            $.mage.__('Please enter a valid Brazilian CEP')
        );
        ...
        $.validator.addMethod(
            ...
            $.mage.__('Please enter a valid Brazilian telephone')
        );
    }
});
