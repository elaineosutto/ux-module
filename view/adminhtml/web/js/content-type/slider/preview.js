    ...
    var Preview =
        ...
        function (_previewCollection2) {
            ...
            _proto.buildSlickConfig = function buildSlickConfig() {
                ...
                let isMobile = this.element.closest('.mobile-viewport.pagebuilder-stage-wrapper') !== null;
                ...
                return {
                    ...
                    swipe: false,
                    slidesToShow: (isMobile)?data.show_slides_mobile : data.show_slides,
                    slidesToScroll: (isMobile)?data.scroll_slides_mobile : data.scroll_slides
                };
            }
            /**
